...
import static accessdb.ConstantsDB.PSW;
import static accessdb.ConstantsDB.USER;
...
public class entrancesManagement {
	 ...
	 * @return boolean vero se la tabella entrate è stat aggiornata, falso altrimenti
	 */
